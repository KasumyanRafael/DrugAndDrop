...
namespace DrugAndDrop2
{
    public partial class FormMain : Form
    {
        ...
        private void buttonSecond_MouseDown(object sender, MouseEventArgs e)
        {
            buttonSourceDrag2.DoDragDrop(buttonSourceDrag2.Text, DragDropEffects.Copy);
        }

        private void pictureBoxSurceDrag_MouseDown(object sender, MouseEventArgs e)
        {
            PictureBox temp = sender as PictureBox;
            temp.DoDragDrop(temp.Image, DragDropEffects.Move);
        }
